...
async def get_unit_vocabulary(unit_id: str):
...
def _calculate_vocabulary_overall_quality(analysis: Dict[str, Any]) -> float:
    ...
    try:
        ...
        return 0.7  # Score padrão do vocabulário
...
async def delete_unit_vocabulary(unit_id: str):
...
async def analyze_unit_vocabulary(unit_id: str):
